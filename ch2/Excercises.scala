...
@main def excercises = 
    ...
    // Q: To parse a command-line argument into an arbitrary type, you need to provide a 
    // “given instance.” For example, to parse a LocalDate:
    //
    // import java.time.*
    // import scala.util.*
    ...
    // of days between them. Your main function should have two parameters of type LocalDate.
